...
<div class="row wd-sl-rowmain">
    <div class="col-xl-4">
        ...
        <div class="card wd-sl-dashcard">
            <div class="card-body">
                <h5 class="mb-4">Sender User</h5>
                <h1>{{$sender}}</h1>
            </div>
        </div>
        <div class="card wd-sl-dashcard">
            <div class="card-body">
                <h5 class="mb-4">Receiver User</h5>
                <h1>{{$receiver}}</h1>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Wallet Transaction</p>
                                <h4 class="mb-0">{{number_to_dec($total,2)}}</h4>
                            </div>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Withdraw  Pending</p>
                                <h4 class="mb-0">{{ number_to_dec(abs($pendingWithdra),2) }}</h4>
                            </div>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Withdraw Approved</p>
                                <h4 class="mb-0">{{ number_to_dec(abs($approveWithdra),2) }}</h4>
                            </div>
