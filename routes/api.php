...
Route::group(['namespace' => 'Api\V1', 'prefix' => 'V1'], function () {
    ...
    Route::post('login-with-google', 'GuestController@login_with_google');
    Route::post('login-with-apple', 'GuestController@login_with_apple');
    Route::post('login_with_linkedin', 'GuestController@login_with_linkedin');
    ...
    Route::group(['middleware' => 'ApiTokenChecker'], function () {
        Route::group(['prefix' => 'user'], function () {
            ...
            Route::post('stripe-intent', 'PaymentController@stripe_intent');
            Route::post('stripe-payment', 'PaymentController@stripe_payment');
        });
    });
});
