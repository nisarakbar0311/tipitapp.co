...
class PaymentController extends ResponseController
{
    ...
    public function stripe_intent(Request $request)
    {
        try{
            // \Stripe\Stripe::setApiKey('sk_test_BHlJPzC6PloLo7ELEKksI1uy00LlQbLa2X');
            \Stripe\Stripe::setApiKey('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');
            // \Stripe\Stripe::setApiKey('sk_test_51M1ycfAb91VIIb3oFuGguLM6VF9GSQwL9WNZNWvin6J1ntew5qdWEON5T1mha4NfkMmMOj0osocDMMd8whxH3jFh00RJsMUYr0');

            $intent = \Stripe\PaymentIntent::create([
              'amount' => 100 * (float)$request->amount,
              'currency' => 'USD',
              'description' => 'Google & Apple Payment',
    ...
    //             'amount' => 100 * (float)$security_request->security_amount,
    //             'currency' => $stripe_config['currency'],
    //             'destination' => $security_person->stripe_account_id,
    //             'transfer_group' => 'Sentinels Payment Apple Pay',
    //         ]);
    //     }catch(\Exception $e)
    //     {
    //         return response()->json([
